...
namespace AutoClicker
{
    public class Cat
    {
        ...
        public void PickUpCat(PlayerData player)
        {
            ...
            if (_pickedUp)
            {
                pos = Raylib.GetMousePosition(); // If the cat is currently being held make it follow player's cursor
                Graphics.DrawText($"Gather Amount: {gatherAmount}", (int)pos.X, (int)pos.Y - 30, 20, Color.White);
            }
        }
